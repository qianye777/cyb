        ...
        <div class="row">
			 ...
			 <div class="form-horizontal m-t">			  
			  <div class="form-group col-lg-7">
                 ...
                 <div class="col-sm-8">
                     <input type="date" id="txt_search_start" name="start" class="laydate-icon form-control layer-date"/>
                     <input type="date" id="txt_search_end" name="end" class="laydate-icon form-control layer-date"/>
                 </div>
	          </div>
		  	</div>
								...
								<td colspan="4">
									<select class="form-control" name="tId" id = "tId">
										...
										<c:forEach items="${typeList }" var="t">
										 	<option value="${t.tId }">${t.tTypename }</option>
										</c:forEach>
				                	</select>
								</td>
							</tr>
							<tr>
								<td valign="middle">入职时间：</td>
								<td colspan="4">
