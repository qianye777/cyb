/*
 ...
 Source Schema         : cyb_day05

 Target Server Type    : MySQL
 Target Server Version : 50527
 File Encoding         : 65001

 Date: 05/08/2020 18:37:20
*/
...
CREATE TABLE `d_dept`  (
  ...
  `d_dname` varchar(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`d_depid`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of d_dept
-- ----------------------------
INSERT INTO `d_dept` VALUES (1, '技术部');
INSERT INTO `d_dept` VALUES (2, '人事部');
INSERT INTO `d_dept` VALUES (3, '财务部');
...
CREATE TABLE `e_emp`  (
  ...
  `e_name` varchar(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `birthday` date NULL DEFAULT NULL,
  `gender` varchar(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `age` int(30) NULL DEFAULT NULL,
  `pic` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `d_depid` int(11) NULL DEFAULT NULL,
  `hobby` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
...
-- Records of e_emp
-- ----------------------------
INSERT INTO `e_emp` VALUES (10, '哟西', '2020-08-06', '女', 123, '1596617630155.jpg', 2, '篮球');
INSERT INTO `e_emp` VALUES (12, '茄子', '2020-08-05', '女', 15, '1596619407427.gif', 3, '篮球,足球,排球');
INSERT INTO `e_emp` VALUES (13, '来根华子', '2020-08-04', '男', 56, '1596619374746.jpg', 1, '排球');
...
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '操作日志记录' ROW_FORMAT = Compact;
...
INSERT INTO `log` VALUES (3, 'admin', '2020-08-05 14:42:44', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (4, 'admin', '2020-08-05 15:13:04', 'intercept the method: com.xiaoshu.controller.EmpController.userList\r\n### Error querying database.  Cause: com.mysql.jdbc.exceptions.jdbc4.MySQLSyntaxErrorException: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near \'\'d_name\' as dname from e_emp e , d_dept d where e.\'d_depid\' = d.\'d_depid\') tmp_c\' at line 1\r\n### The error may exist in file [E:\\Kaos\\apache-tomcat-7.0.72\\wtpwebapps\\cyb_ssm\\WEB-INF\\classes\\mapper\\EmpMapper.xml]\r\n### The error may involve com.xiaoshu.dao.EmpMapper.findPage-Inline\r\n### The error occurred while setting parameters\r\n### SQL: select count(0) from (select e.*,d.\'d_name\' as dname from e_emp e , d_dept d where e.\'d_depid\' = d.\'d_depid\') tmp_count\r\n### Cause: com.mysql.jdbc.exceptions.jdbc4.MySQLSyntaxErrorException: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near \'\'d_name\' as dname from e_emp e , d_dept d where e.\'d_depid\' = d.\'d_depid\') tmp_c\' at line 1\n; bad SQL grammar []; nested exception is com.mysql.jdbc.exceptions.jdbc4.MySQLSyntaxErrorException: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near \'\'d_name\' as dname from e_emp e , d_dept d where e.\'d_depid\' = d.\'d_depid\') tmp_c\' at line 1', '拦截到异常', '0:0:0:0:0:0:0:1', '/ssm');
INSERT INTO `log` VALUES (5, 'admin', '2020-08-05 15:15:06', 'intercept the method: com.xiaoshu.controller.EmpController.userList\r\n### Error querying database.  Cause: com.mysql.jdbc.exceptions.jdbc4.MySQLSyntaxErrorException: Unknown column \'d.d_name\' in \'field list\'\r\n### The error may exist in file [E:\\Kaos\\apache-tomcat-7.0.72\\wtpwebapps\\cyb_ssm\\WEB-INF\\classes\\mapper\\EmpMapper.xml]\r\n### The error may involve com.xiaoshu.dao.EmpMapper.findPage-Inline\r\n### The error occurred while setting parameters\r\n### SQL: select e.*,d.d_name as dname from e_emp e , d_dept d where e.d_depid = d.d_depid LIMIT 10\r\n### Cause: com.mysql.jdbc.exceptions.jdbc4.MySQLSyntaxErrorException: Unknown column \'d.d_name\' in \'field list\'\n; bad SQL grammar []; nested exception is com.mysql.jdbc.exceptions.jdbc4.MySQLSyntaxErrorException: Unknown column \'d.d_name\' in \'field list\'', '拦截到异常', '0:0:0:0:0:0:0:1', '/ssm');
INSERT INTO `log` VALUES (6, 'admin', '2020-08-05 15:48:33', NULL, '退出', NULL, NULL);
INSERT INTO `log` VALUES (7, 'admin', '2020-08-05 15:48:38', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (8, 'admin', '2020-08-05 18:29:42', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
...
INSERT INTO `menu` VALUES (9, '人员管理', 'emp/empIndex.htm', 2, '', NULL, '', 5);
...
INSERT INTO `operation` VALUES (10015, '添加', 9, '人员管理', 'btn_add', '');
INSERT INTO `operation` VALUES (10016, '修改', 9, '人员管理', 'btn_edit', '');
INSERT INTO `operation` VALUES (10017, '删除', 9, '人员管理', 'btn_delete', '');
