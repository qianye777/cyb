...
<body class="gray-bg">
					...
					<form id="form_user" method="post" action="reserveEmp.htm" enctype="multipart/form-data">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<td>生日：</td>
								<td>
									<input readonly="readonly" id="txt_search_birthday" name="birthday" class="laydate-icon form-control layer-date"/>
								</td>
							</tr>
							<tr>
								<td>性别：</td>
								...
								<td>爱好：</td>
								<td>
									<input type="checkbox" name="hobby" id="hobby1" value="篮球">篮球
									<input type="checkbox" name="hobby" id="hobby2" value="足球">足球
									<input type="checkbox" name="hobby" id="hobby3" value="排球">排球
								</td>
							</tr>
							<tr>
								<td>图片：</td>
								<td>
									<img alt="" id="pics" src="" width="50px" height="50px">
	        ...
	        $('#table_user').bootstrapTable({
	           ...
	           // height: 500,                        //行高，如果没有设置height属性，表格自动根据记录条数觉得表格高度
	            ...
	            },
	            {
	                ...
	                title: '图片',
	                formatter:function(value,row,index){
	                	return "<img src='/photo/"+value+"' width='100px' height='100px'>";
	                }
	            },{
	                field: 'hobby',
	                title: '爱好'
	...
	function initEditUser(getSelection){
		...
		$('#txt_search_birthday').val(new Date(getSelection.birthday).Format('yyyy-MM-dd'));
		$("input[value="+getSelection.gender+"]").prop("checked",true);
		$('#age').val(getSelection.age);
		$('#pics').attr('src',"/photo/"+getSelection.pic);
