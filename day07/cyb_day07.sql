/*
 ...
 Source Schema         : cyb_day07

 Target Server Type    : MySQL
 Target Server Version : 50527
 File Encoding         : 65001

 Date: 07/08/2020 20:47:55
*/
...
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '操作日志记录' ROW_FORMAT = Compact;
...
INSERT INTO `log` VALUES (3, 'admin', '2020-08-07 20:42:57', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (4, 'admin', '2020-08-07 20:45:23', NULL, '退出', NULL, NULL);
INSERT INTO `log` VALUES (5, 'admin', '2020-08-07 20:45:27', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
...
INSERT INTO `menu` VALUES (9, '学生管理', 'student/stuIndex.htm', 2, '', NULL, '', 5);
...
INSERT INTO `operation` VALUES (10018, '表单', 9, '学生管理', 'btn_echarts', '');
...
CREATE TABLE `student`  (
  ...
  `joinschooltime` date NULL DEFAULT NULL,
  `tid` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`sid`) USING BTREE,
  INDEX `wj1`(`tid`) USING BTREE,
  CONSTRAINT `wj1` FOREIGN KEY (`tid`) REFERENCES `teacher` (`tid`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of student
-- ----------------------------
INSERT INTO `student` VALUES (1, '杨孟泽', '女', '17bfc9c0-12c2-4f51-8c1a-5fdbafad159f.png', '2011-05-05', 1);
INSERT INTO `student` VALUES (2, '凯旋真怪', '女', '0903385c-c872-47d2-a4e6-27ed868c6f76.jpg', '2020-08-04', 3);
...
-- Records of teacher
-- ----------------------------
INSERT INTO `teacher` VALUES (1, '张洪来');
INSERT INTO `teacher` VALUES (2, '大苏');
INSERT INTO `teacher` VALUES (3, '香蕉皮');
