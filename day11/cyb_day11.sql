/*
 ...
 Source Schema         : cyb_day11

 Target Server Type    : MySQL
 Target Server Version : 50527
 File Encoding         : 65001

 Date: 12/08/2020 18:48:28
*/
...
CREATE TABLE `content`  (
  ...
  INDEX `wj1`(`contentCategoryId`) USING BTREE,
  CONSTRAINT `wj1` FOREIGN KEY (`contentCategoryId`) REFERENCES `contentcategory` (`contentCategoryId`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of content
-- ----------------------------
INSERT INTO `content` VALUES (1, 2, '限时促销', 'www.4399.cn', '1.0.jpg', '300', '3015-05-05 00:00:00', '禁用');
INSERT INTO `content` VALUES (2, 3, '打折促销', 'www.2144.com', '2.jpg', '300', '2456-08-09 00:00:00', '启用');
INSERT INTO `content` VALUES (4, 1, 'giaogiao', 'www.giao.com', '4.jpg', '211', '2020-08-12 17:08:39', '启用');
INSERT INTO `content` VALUES (5, 2, '大西瓜不好吃', 'www.gua.com', '5.jpg', '123', '2020-08-12 17:11:59', '启用');
...
-- ----------------------------
INSERT INTO `contentcategory` VALUES (1, '品牌广告', '1', '2000-04-04 00:00:00');
INSERT INTO `contentcategory` VALUES (2, '产品广告', '1', '2020-09-09 00:00:00');
INSERT INTO `contentcategory` VALUES (3, '公益广告', '1', '4562-07-05 00:00:00');
...
INSERT INTO `log` VALUES (3, 'admin', '2020-08-12 15:59:19', NULL, '登录', '127.0.0.1', NULL);
INSERT INTO `log` VALUES (4, 'admin', '2020-08-12 16:49:11', NULL, '退出', NULL, NULL);
INSERT INTO `log` VALUES (5, 'admin', '2020-08-12 16:49:16', NULL, '登录', '127.0.0.1', NULL);
INSERT INTO `log` VALUES (6, 'admin', '2020-08-12 17:03:23', NULL, '退出', NULL, NULL);
INSERT INTO `log` VALUES (7, 'admin', '2020-08-12 17:03:29', NULL, '登录', '127.0.0.1', NULL);
INSERT INTO `log` VALUES (8, 'admin', '2020-08-12 18:40:08', NULL, '登录', '127.0.0.1', NULL);
...
INSERT INTO `menu` VALUES (9, '广告管理', 'content/contentIndex.htm', 2, '', NULL, '', 5);
...
INSERT INTO `operation` VALUES (10016, '修改', 9, '广告管理', 'btn_edit', '');
INSERT INTO `operation` VALUES (10017, '删除', 9, '广告管理', 'btn_delete', '');
INSERT INTO `operation` VALUES (10018, '报表', 9, '广告管理', 'btn_echarts', '');
