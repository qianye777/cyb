/*
 ...
 Source Schema         : cyb_day04

 Target Server Type    : MySQL
 Target Server Version : 50527
 File Encoding         : 65001

 Date: 04/08/2020 16:56:19
*/
...
INSERT INTO `log` VALUES (3, 'admin', '2020-08-04 15:57:39', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (4, 'admin', '2020-08-04 16:17:57', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (5, 'admin', '2020-08-04 16:30:26', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (6, 'admin', '2020-08-04 16:31:19', NULL, '退出', NULL, NULL);
INSERT INTO `log` VALUES (7, 'admin', '2020-08-04 16:31:23', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
...
INSERT INTO `operation` VALUES (10015, '添加', 9, '快递员管理', 'btn_add', '');
INSERT INTO `operation` VALUES (10016, '修改', 9, '快递员管理', 'btn_edit', '');
INSERT INTO `operation` VALUES (10017, '删除', 9, '快递员管理', 'btn_delete', '');
...
INSERT INTO `p_company` VALUES (2, '申通快递');
INSERT INTO `p_company` VALUES (3, '顺丰快递');
...
CREATE TABLE `p_person`  (
  ...
  INDEX `wj1`(`company_id`) USING BTREE,
  CONSTRAINT `wj1` FOREIGN KEY (`company_id`) REFERENCES `p_company` (`company_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of p_person
-- ----------------------------
INSERT INTO `p_person` VALUES (1, '闰土', '男', 1, '2001-05-08');
INSERT INTO `p_person` VALUES (2, '药水哥', '男', 2, '2020-08-10');
INSERT INTO `p_person` VALUES (3, '我giao', '女', 3, '2020-08-20');
