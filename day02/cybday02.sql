/*
 ...
 Source Schema         : cybday02

 Target Server Type    : MySQL
 Target Server Version : 50527
 File Encoding         : 65001

 Date: 02/08/2020 21:01:16
*/
...
CREATE TABLE `device`  (
  ...
  `deviceram` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `color` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `price` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `status` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `devicecreatime` date NULL DEFAULT NULL,
  `devicetypeId` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`deviceId`) USING BTREE,
  INDEX `wj1`(`devicetypeId`) USING BTREE,
  CONSTRAINT `wj1` FOREIGN KEY (`devicetypeId`) REFERENCES `devicetype` (`devicetypeId`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of device
-- ----------------------------
INSERT INTO `device` VALUES (2, '小米', '64G', '黑色', '11', '启用', '2000-05-05', 1);
INSERT INTO `device` VALUES (3, '华为', '54G', '蓝色', '22', '启用', '2001-01-01', 2);
INSERT INTO `device` VALUES (4, '1', '1', '1', '1', '启用', '2020-08-02', 1);
...
-- ----------------------------
INSERT INTO `devicetype` VALUES (1, 'Android_phone', '启用', '2020-02-05');
INSERT INTO `devicetype` VALUES (2, 'IOS_Phone', '启用', '2011-01-01');
INSERT INTO `devicetype` VALUES (3, 'IOS_pad', '启用', '2020-05-08');
INSERT INTO `devicetype` VALUES (4, 'Android_Pad', '启用', '2011-05-08');
...
) ENGINE = InnoDB AUTO_INCREMENT = 14 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '操作日志记录' ROW_FORMAT = Compact;
...
INSERT INTO `log` VALUES (3, 'admin', '2020-08-02 19:44:21', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (4, 'admin', '2020-08-02 19:47:47', NULL, '退出', NULL, NULL);
INSERT INTO `log` VALUES (5, 'admin', '2020-08-02 19:47:53', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (6, 'admin', '2020-08-02 20:07:31', NULL, '退出', NULL, NULL);
INSERT INTO `log` VALUES (7, 'admin', '2020-08-02 20:07:39', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (8, 'admin', '2020-08-02 20:33:53', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (9, 'admin', '2020-08-02 20:34:39', NULL, '退出', NULL, NULL);
INSERT INTO `log` VALUES (10, 'admin', '2020-08-02 20:34:44', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (11, 'admin', '2020-08-02 20:51:18', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (12, 'admin', '2020-08-02 20:54:22', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (13, 'admin', '2020-08-02 20:59:33', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
...
INSERT INTO `menu` VALUES (9, '设备管理', 'device/deviceIndex.htm', 2, '', NULL, '', 5);
...
INSERT INTO `operation` VALUES (10015, '添加', 9, '设备管理', 'btn_add', '');
INSERT INTO `operation` VALUES (10016, '删除', 9, '设备管理', 'btn_delete', '');
INSERT INTO `operation` VALUES (10017, '导出', 9, '设备管理', 'btn_exp', '');
