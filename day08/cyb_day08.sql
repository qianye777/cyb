/*
 ...
 Source Schema         : cyb_day08

 Target Server Type    : MySQL
 Target Server Version : 50527
 File Encoding         : 65001

 Date: 09/08/2020 19:46:23
*/
...
INSERT INTO `log` VALUES (3, 'admin', '2020-08-09 16:37:40', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (4, 'admin', '2020-08-09 16:52:36', NULL, '退出', NULL, NULL);
INSERT INTO `log` VALUES (5, 'admin', '2020-08-09 16:52:49', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (6, 'admin', '2020-08-09 17:07:12', NULL, '退出', NULL, NULL);
INSERT INTO `log` VALUES (7, 'admin', '2020-08-09 17:07:17', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (8, 'admin', '2020-08-09 18:43:51', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (9, 'admin', '2020-08-09 18:53:09', NULL, '退出', NULL, NULL);
INSERT INTO `log` VALUES (10, 'admin', '2020-08-09 18:53:14', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
...
INSERT INTO `school` VALUES (2, '清华大学');
INSERT INTO `school` VALUES (3, '北师大');
...
CREATE TABLE `student`  (
  ...
  INDEX `wj1`(`sid`) USING BTREE,
  CONSTRAINT `wj1` FOREIGN KEY (`sid`) REFERENCES `school` (`sid`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of student
-- ----------------------------
INSERT INTO `student` VALUES (1, '张毅', '2010-05-05', 18, '男', 1);
INSERT INTO `student` VALUES (3, '二傻', '2020-08-09', 25, '女', 3);
